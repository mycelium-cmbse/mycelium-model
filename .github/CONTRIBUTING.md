...
We would like to start with saying thank you for wanting to contribute to mycelium-model UML master models. We want to keep it as easy as possible to contribute changes that get things working in your environment. There are a few guidelines that we need contributors to follow so that we have a chance of keeping on top of things.
...
1. Configure the upstream repo (`git remote add upstream https://github.com/mycelium-cmbse/mycelium-model`) 
...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical mycelium-model version) may be updated. If this happens you should:
...
1. Wait for a team member to merge your changes in.